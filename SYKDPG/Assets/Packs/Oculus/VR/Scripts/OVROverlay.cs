...
#region Interface
	...
	/// <summary>
	/// If true, the layer would be used to present protected content (e.MeshObject. HDCP). The flag is effective only on PC.
	/// </summary>
	[Tooltip("If true, the layer would be used to present protected content (e.MeshObject. HDCP). The flag is effective only on PC.")]
