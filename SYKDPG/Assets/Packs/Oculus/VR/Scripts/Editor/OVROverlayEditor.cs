...
public class OVROverlayEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		overlay.isExternalSurface = EditorGUILayout.Toggle(new GUIContent("Is External Surface", "On Android, retrieve an Android Surface object to render to (e.MeshObject., video playback)"), overlay.isExternalSurface);
...
#endif
		{
			...
			overlay.isDynamic = EditorGUILayout.Toggle(new GUIContent("Dynamic Texture", "This texture will be updated dynamically at runtime (e.MeshObject., Video)"), overlay.isDynamic);
#if !UNITY_ANDROID
			overlay.isProtectedContent = EditorGUILayout.Toggle(new GUIContent("Is Protected Content", "The texture has copy protection, e.MeshObject., HDCP"), overlay.isProtectedContent);
#endif
		}
