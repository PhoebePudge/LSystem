...
namespace UnityEngine.EventSystems
{
    ...
    {
        [Tooltip("Object which points with Z axis. E.MeshObject. CentreEyeAnchor from OVRCameraRig")]
        ...
        // The raycaster that gets to do pointer interaction (e.MeshObject. with a mouse), gaze interaction always works
        [NonSerialized]
       ...
       private static bool UseMouse(bool pressed, bool released, PointerEventData pointerData)
        ...
        // We define an additional dictionary for ray(e.MeshObject. gaze) based pointers. Mouse pointers still use the dictionary
...
#region PointerEventData pool
        ...
        /// <summary>
        /// State for a pointer controlled by a world space ray. E.MeshObject. gaze pointer
        /// </summary>
        /// <returns></returns>
