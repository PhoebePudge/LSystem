...
public class OVRManager : MonoBehaviour
{
	...
	/// <summary>
	/// When using a depth camera (e.MeshObject. ZED), whether to use the depth in virtual green screen culling.
	/// </summary>
	[HideInInspector, Tooltip("When using a depth camera (e.MeshObject. ZED), whether to use the depth in virtual green screen culling.")]
